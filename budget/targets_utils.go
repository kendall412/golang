...
func utilsTargets() []Targets {
	var pg_e Targets
	pg_e.Name = "pg&e"
	pg_e.Cat = []string{cats["util"], cats["vari"]}
	pg_e.Variant = []string{"pg&e"}

	var smud Targets
	smud.Name = "smud"
	smud.Cat = []string{cats["util"], cats["vari"]}
	smud.Variant = []string{"smud"}

	var comcast Targets
	comcast.Name = "xfinity"
	comcast.Cat = []string{cats["util"], cats["con"]}
	comcast.Variant = []string{"comcast"}

	var verizon Targets
	verizon.Name = "verizon"
	verizon.Cat = []string{cats["util"], cats["con"]}
	verizon.Variant = []string{"verizon", "vzwrlss"}
